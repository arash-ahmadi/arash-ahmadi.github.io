  ...
  $(window).bind('load', function () {
    axios.post('https://api.viubox.com:8000/portal/checkurl', { url: origin }).then((res) => {
      if (res.data.urlExists === true) {
        ...
        axios.get('https://api.viubox.com:8000/ifItemExists', { params: { sku: syzsku, origin: origin } }).then((res) => {
          if (res.data.itemExists === true) {
            ...
            console.log('This product is not available in ViuBox SYZ. ViuBox SYZ will not load unless the item is present in the system');
          }
        });
