let html = '<iframe id="receiver" class="chatbox" allowtransparency: true; style = "position: fixed; z-index: 1310; bottom: 0px; right: 0px; border: 0px; width: 400px; height: 100vh; overflow-x: hidden; overflow-y: auto;" src = "localhost:3000"></iframe >';
        ...
        window.onmessage = function(event){
            ...
            if (event.data.message == 'Open App') {
                ...
                if(loaded) {
                    ...
                    var receiver = document.getElementById('receiver').contentWindow;
                    receiver.postMessage(msg, 'http://localhost:3000/');
                }
